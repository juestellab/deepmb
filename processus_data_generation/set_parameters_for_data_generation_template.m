...
device_id = '???';                                   % Id of a MOST device defined in the model-based reconstruction toolbox.
...
regularization = 'L1_SHEARLET';                      % ['L1_SHEARLET' or 'L2_TIKHONOV_AND_LAPLACIAN'] Type of regularization during model-based reconstruction
lambda_shearlet = 1e-2;                              % Strength of Shearlet L1 regularization, only used if regularization = 'L1_SHEARLET' 
