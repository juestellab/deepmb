...
def get_parameters():
  ...
  p = parameters.Parameters(
    ...
    EXPERIMENT_NAME = 'gz41_like_cd49_but_without_sos_and_for_of_focus',
    
    ### Scanner ID
    # Keyword to define the scanner (see "package_geometry/geometry.py")
    SCANNER_ID = 'Acuity_256e_125d',

    ### Path and data
    # Root folder containing all the different datasets that can be processed
    DATA_PATH = '/home/DATA/DEEP_MODEL_BASED/dataset_orange_probe/',
    # Folder where the results are be saved (automatically created if it does not already exist)
    SAVE_PATH = '/home/guillaume/TMP_RESULTS/',
    ...
    DATASET_NAME_TST = '210504_dmb_test_invivo_subset_all_sos_orange_probe',
    ...
    SOS_RANGE = [1495, 1500, 1505, 1510, 1515, 1520, 1525, 1530, 1535, 1540, 1545],
