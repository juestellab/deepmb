...
def define_datasets(p, num_workers):
  ...
  if not p.ALTERNATIVE_TRAINING_ON_IN_VIVO_DATA:
    ...
    flip_trn = False  # Synthetic images are already in the correct orientation (for display and printing purpose only)
    flip_val = False  # Synthetic images are already in the correct orientation (for display and printing purpose only)
    flip_tst = True   # In vivo images need to be flipped upside-down (for display and printing purpose only)
  ...
  # DeepMB "alternative" case: training, validation, and testing on in vivo data, following a 4/1/1 split
    ...
    flip_trn = True  # In vivo images need to be flipped upside-down (for display and printing purpose only)
    flip_val = True  # In vivo images need to be flipped upside-down (for display and printing purpose only)
    flip_tst = True  # In vivo images need to be flipped upside-down (for display and printing purpose only)
